...
class _OnBoardingScreenState extends State<OnBoardingScreen>
            ...
            return Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      CustomSVGImage(image: AssetsManager.logo, height: 38, width: 38),
                      Spacer(
                        flex: 1,
                      ),
                      TextButton(
                        ...
                        child: Text(AppStrings.lblSkip,
                            style: getRegularStyle(color:ColorsManager.purpleNavy,fontSize: 15)),
                      ),
                    ],
                  ),
                  30.height,
                  ...
                  Row(
                    children: [
                      buildCircleCount(),
                      // CustomPaint(
                      //   foregroundPainter: CustomCircleCount(),
                      //   child: Container(),
                      // ),
                      Spacer(
                        flex: 1,
  ...
  Widget buildCircleCount()=> SizedBox(
    ...
    child: CircularPercentIndicator(
        ...
        lineWidth: 3.0,
        percent: angle,
        center:  Text(count,style: getRegularStyle(color: angleColor),),
        backgroundColor: backgroundColor,
        progressColor: angleColor,
    ),
  );
  Widget buildNextBut() => ElevatedButton(
        onPressed: () async {
          changeCircle();
        ...
        style: ElevatedButton.styleFrom(
          backgroundColor: ColorsManager.purpleNavy,
          minimumSize: Size(104, 41),
        ...
        child: Row(
          children: [
            Text(
              currentPosition==3?'get start': 'Next',
              style: getBoldStyle(color: ColorsManager.white,fontSize: 15),
            ),
            if( currentPosition==3)
            SizedBox(width: AppConstants.width*AppWidth.s8,),
            if( currentPosition==3)
              CircleAvatar(child: Icon(Icons.arrow_forward,size: 15),radius: 10,)
          ],
        ),
      );
